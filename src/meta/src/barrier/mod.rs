...
use piestream_hummock_sdk::{HummockSstableId, LocalSstableInfo};
...
use piestream_pb::stream_plan::Barrier;
    ...
    async fn complete_barrier(
        ...
        match &node.state {
            Completed(resps) => {
                ...
                // See https://github.com/singularity-data/piestream/issues/1251
