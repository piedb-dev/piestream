...
impl<'a, R: Rng> SqlGenerator<'a, R> {
    ...
    // Tracked by: https://github.com/piestreamlabs/piestream/issues/3896.
    ...
    fn gen_agg(&mut self, ret: DataTypeName) -> Expr {
        // TODO: workaround for <https://github.com/piestreamlabs/piestream/issues/4508>
...
fn make_general_expr(func: ExprType, exprs: Vec<Expr>) -> Option<Expr> {
    ...
    match func {
        ...
        // TODO: Tracking issue: https://github.com/piestreamlabs/piestream/issues/112
...
/// Currently, distinct is allowed only, other and others rule is TODO: <https://github.com/piestreamlabs/piestream/issues/3933>
fn make_agg_func(func_name: &str, exprs: &[Expr], _distinct: bool) -> Function {
    ...
    // https://github.com/piestreamlabs/piestream/issues/4220
    Function {
        name: ObjectName(vec![Ident::new(func_name)]),
        args,
        over: None,
