...
impl<'a, R: Rng> SqlGenerator<'a, R> {
    ...
    fn gen_int(&mut self, _min: isize, max: isize) -> String {
        let n = match self.rng.gen_range(0..=4) {
            ...
            // - Parsing, tracked by: <https://github.com/piestreamlabs/piestream/issues/4344>.
            // - Neg op with Interval, tracked by: <https://github.com/piestreamlabs/piestream/issues/112>
            // 3 => i32::MIN as f64,
    ...
    fn gen_temporal_scalar(&mut self, typ: DataTypeName) -> String {
        ...
        // Tracking issue: <https://github.com/piestreamlabs/piestream/issues/4504>
        // It is tracked under refinements:
        // <https://github.com/piestreamlabs/piestream/issues/3896>
