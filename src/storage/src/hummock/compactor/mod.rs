...
use piestream_hummock_sdk::filter_key_extractor::FilterKeyExtractorImpl;
use piestream_hummock_sdk::key::{get_epoch, user_key, FullKey};
...
impl Compactor {
        ...
        F: TableBuilderFactory,
    {
        ...
        while iter.is_valid() {
            ...
            sst_builder
                .add_full_key(iter_key, value.as_slice(), is_new_user_key)
                .await?;
