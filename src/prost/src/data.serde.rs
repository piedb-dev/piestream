                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::FieldType => {
                            ...
                            field_type = Some(map.next_value()?);
                        }
                    }
                }
                Ok(DataType {
...
impl serde::Serialize for DispatcherMutation {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("data.DispatcherMutation", len)?;
        if self.actor_id != 0 {
...
impl<'de> serde::Deserialize<'de> for DispatcherMutation {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DispatcherMutation;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct data.DispatcherMutation")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<DispatcherMutation, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("data.DispatcherMutation", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for IntervalUnit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("data.IntervalUnit", len)?;
        if self.months != 0 {
        ...
        if self.ms != 0 {
            struct_ser.serialize_field("ms", ToString::to_string(&self.ms).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for IntervalUnit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct data.IntervalUnit")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<IntervalUnit, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut months = None;
        ...
        deserializer.deserialize_struct("data.IntervalUnit", FIELDS, GeneratedVisitor)
    }
}
