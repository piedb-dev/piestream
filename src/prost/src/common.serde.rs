...
impl serde::Serialize for ParallelUnitMapping {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("common.ParallelUnitMapping", len)?;
        if self.table_id != 0 {
...
impl<'de> serde::Deserialize<'de> for ParallelUnitMapping {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct common.ParallelUnitMapping")
            }
        ...
        deserializer.deserialize_struct("common.ParallelUnitMapping", FIELDS, GeneratedVisitor)
    }
}
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "COMPACTOR" => Ok(WorkerType::Compactor),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
