...
impl serde::Serialize for SyncSourcesRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("stream_service.SyncSourcesRequest", len)?;
        if !self.sources.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SyncSourcesRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SyncSourcesRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct stream_service.SyncSourcesRequest")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<SyncSourcesRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(SyncSourcesRequest {
                    sources: sources.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("stream_service.SyncSourcesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SyncSourcesResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("stream_service.SyncSourcesResponse", len)?;
        if let Some(v) = self.status.as_ref() {
            struct_ser.serialize_field("status", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SyncSourcesResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SyncSourcesResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct stream_service.SyncSourcesResponse")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<SyncSourcesResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut status = None;
                ...
                Ok(SyncSourcesResponse {
                    status,
                })
            }
        }
        deserializer.deserialize_struct("stream_service.SyncSourcesResponse", FIELDS, GeneratedVisitor)
    }
}
