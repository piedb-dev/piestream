...
impl serde::Serialize for CompactTask {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.prefix_pairs.is_empty() {
            len += 1;
        }
        if !self.vnode_mappings.is_empty() {
            len += 1;
        }
        ...
        if !self.prefix_pairs.is_empty() {
            struct_ser.serialize_field("prefixPairs", &self.prefix_pairs)?;
        }
        if !self.vnode_mappings.is_empty() {
            struct_ser.serialize_field("vnodeMappings", &self.vnode_mappings)?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "prefixPairs" => Ok(GeneratedField::PrefixPairs),
                            "vnodeMappings" => Ok(GeneratedField::VnodeMappings),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut prefix_pairs = None;
                let mut vnode_mappings = None;
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::PrefixPairs => {
                            if prefix_pairs.is_some() {
                                return Err(serde::de::Error::duplicate_field("prefixPairs"));
                            }
                            prefix_pairs = Some(map.next_value()?);
                        }
                        GeneratedField::VnodeMappings => {
                            if vnode_mappings.is_some() {
                                return Err(serde::de::Error::duplicate_field("vnodeMappings"));
                            }
                            vnode_mappings = Some(map.next_value()?);
                        }
                    }
                }
                Ok(CompactTask {
                    ...
                    prefix_pairs: prefix_pairs.unwrap_or_default(),
                    vnode_mappings: vnode_mappings.unwrap_or_default(),
                })
            }
        }
...
impl serde::Serialize for CompactionGroup {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("hummock.CompactionGroup", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CompactionGroup {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<CompactionGroup, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for compaction_group::PrefixPair {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hummock.CompactionGroup.PrefixPair", len)?;
        if self.group_id != 0 {
...
impl<'de> serde::Deserialize<'de> for compaction_group::PrefixPair {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = compaction_group::PrefixPair;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hummock.CompactionGroup.PrefixPair")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<compaction_group::PrefixPair, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(compaction_group::PrefixPair {
                    group_id: group_id.unwrap_or_default(),
                    prefix: prefix.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("hummock.CompactionGroup.PrefixPair", FIELDS, GeneratedVisitor)
    }
}
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "tableInfos" => Ok(GeneratedField::TableInfos),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::TableInfos => {
                            if table_infos.is_some() {
                                return Err(serde::de::Error::duplicate_field("tableInfos"));
                            }
                            table_infos = Some(map.next_value()?);
                        }
                    }
                }
                Ok(Level {
                    ...
                    table_infos: table_infos.unwrap_or_default(),
                })
            }
        }
...
impl serde::Serialize for level_handler::SstTask {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hummock.LevelHandler.SstTask", len)?;
        if self.task_id != 0 {
            struct_ser.serialize_field("taskId", ToString::to_string(&self.task_id).as_str())?;
        }
        if !self.ssts.is_empty() {
...
impl<'de> serde::Deserialize<'de> for level_handler::SstTask {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = level_handler::SstTask;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hummock.LevelHandler.SstTask")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<level_handler::SstTask, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut task_id = None;
                ...
                Ok(level_handler::SstTask {
                    task_id: task_id.unwrap_or_default(),
                    ssts: ssts.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("hummock.LevelHandler.SstTask", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SstableInfo {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.vnode_bitmaps.is_empty() {
            len += 1;
        }
        ...
        if !self.vnode_bitmaps.is_empty() {
            struct_ser.serialize_field("vnodeBitmaps", &self.vnode_bitmaps)?;
        }
        struct_ser.end()
    }
}
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "vnodeBitmaps" => Ok(GeneratedField::VnodeBitmaps),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::VnodeBitmaps => {
                            if vnode_bitmaps.is_some() {
                                return Err(serde::de::Error::duplicate_field("vnodeBitmaps"));
                            }
                            vnode_bitmaps = Some(map.next_value()?);
                        }
                    }
                }
                Ok(SstableInfo {
                    ...
                    vnode_bitmaps: vnode_bitmaps.unwrap_or_default(),
                })
            }
        }
...
impl serde::Serialize for VNodeBitmap {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hummock.VNodeBitmap", len)?;
        if self.table_id != 0 {
            struct_ser.serialize_field("tableId", &self.table_id)?;
        }
        if self.maplen != 0 {
            struct_ser.serialize_field("maplen", &self.maplen)?;
        }
        if !self.bitmap.is_empty() {
...
impl<'de> serde::Deserialize<'de> for VNodeBitmap {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "tableId" => Ok(GeneratedField::TableId),
                            "maplen" => Ok(GeneratedField::Maplen),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = VNodeBitmap;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hummock.VNodeBitmap")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<VNodeBitmap, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut table_id = None;
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::Maplen => {
                            if maplen.is_some() {
                                return Err(serde::de::Error::duplicate_field("maplen"));
                            }
                            maplen = Some(
                                map.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0
                            );
                ...
                Ok(VNodeBitmap {
                    table_id: table_id.unwrap_or_default(),
                    maplen: maplen.unwrap_or_default(),
                    bitmap: bitmap.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("hummock.VNodeBitmap", FIELDS, GeneratedVisitor)
    }
}
